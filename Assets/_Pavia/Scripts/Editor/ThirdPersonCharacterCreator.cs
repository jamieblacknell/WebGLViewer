...
public class ThirdPersonCharacterCreator
{
    private const string AnimatorPath = "Resources/StarterAssetsThirdPerson.controller"; 
    private const string InputAssetPath = "Resources/StarterAssets.inputactions";
